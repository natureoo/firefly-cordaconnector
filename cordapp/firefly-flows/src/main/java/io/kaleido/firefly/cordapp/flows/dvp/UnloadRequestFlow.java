...
public class UnloadRequestFlow {
    @InitiatingFlow
    @StartableByRPC
    public static class UnloadRequest extends CreateFireflyEventFlow<CashMovementState> {
...
//        private String batchId;
        ...
        public UnloadRequest( Party settlementBank, Participant payer, Participant payee, AccountInfo fromAccount, AccountInfo toAccount, String customerRefNumber, BigDecimal instructedMVUnit, Currency instructedMVCurrency) {
...
//            this.batchId = batchId;
        ...
        public static class GENERATING_TRANSACTION extends ProgressTracker.Step {
            public GENERATING_TRANSACTION() {
                super("Generating transaction based on a new Cash Unload Request");
            }
        }
...
//        setStep(GENERATING_TRANSACTION);
        CashMovementState cashMovementState = new CashMovementState(
                ...
                Instant.now(),
                CashMovementStatus.UNLOAD_REQUEST,
                new UniqueIdentifier()
        );
        Command<CashMovementContract.Commands.CashUnloadRequestCmd> txCmd = new Command<>(
                new CashMovementContract.Commands.CashUnloadRequestCmd(),
...
//                .collect(Collectors.toList());
    ...
    @InitiatedBy(UnloadRequestFlow.UnloadRequest.class)
