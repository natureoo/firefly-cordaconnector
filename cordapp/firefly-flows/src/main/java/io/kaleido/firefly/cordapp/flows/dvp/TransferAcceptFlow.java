...
public class TransferAcceptFlow {
    @InitiatingFlow
    @StartableByRPC
    public static class TransferAcceptance extends FlowLogic<SignedTransaction> {
        private UniqueIdentifier linearId;
        private String settlementBankRef;
        private Instant settlementDate;

        public TransferAcceptance(UniqueIdentifier linearId, String settlementBankRef, Instant settlementDate) {
...
//            setStep(QUERYING_TRANSACTION);
            ...
            cashMovementOutputState.setStatus(CashMovementStatus.TRANSFER_COMPLETED);
...
//            setStep(MODIFYING_TRANSACTION);
            ...
            Command<CashMovementContract.Commands.CashTransferCompleteCmd> txCmd = new Command<>(
                    new CashMovementContract.Commands.CashTransferCompleteCmd(),
...
//            }
    ...
    @InitiatedBy(TransferAcceptFlow.TransferAcceptance.class)
