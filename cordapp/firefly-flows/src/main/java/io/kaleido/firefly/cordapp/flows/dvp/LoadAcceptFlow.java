...
public class LoadAcceptFlow {
    @InitiatingFlow
    @StartableByRPC
    public static class LoadAcceptance extends FlowLogic<SignedTransaction> {
        private UniqueIdentifier linearId;
        private String settlementBankRef;
        private Instant settlementDate;

        public LoadAcceptance(UniqueIdentifier linearId, String settlementBankRef, Instant settlementDate) {
...
//            setStep(QUERYING_TRANSACTION);
            ...
            cashMovementOutputState.setStatus(CashMovementStatus.LOAD_COMPLETED);
...
//            setStep(MODIFYING_TRANSACTION);
            ...
            Command<CashMovementContract.Commands.CashLoadCompleteCmd> txCmd = new Command<>(
                    new CashMovementContract.Commands.CashLoadCompleteCmd(),
...
//            }
    ...
    @InitiatedBy(LoadAcceptFlow.LoadAcceptance.class)
